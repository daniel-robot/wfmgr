    ...
    private static readonly IReadOnlyDictionary<string, string> DefaultWorkItemRoles =
        new ReadOnlyDictionary<string, string>(
            new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                [WorkItemTypes.ManualContouring]           = "Doctor/ThirdPartyOperator",
                [WorkItemTypes.ContourReview]              = "Doctor",
                [WorkItemTypes.ContourSecondReview]        = "Doctor/Physicist",
                [WorkItemTypes.ContourRework]              = "Doctor/ThirdPartyOperator",
                [WorkItemTypes.PlanAssignment]             = "Scheduler/System",
                [WorkItemTypes.PlanDesign]                 = "Dosimetrist",
                [WorkItemTypes.PlanEvaluation]             = "Physicist/Doctor",
                [WorkItemTypes.PlanReReview]               = "ChiefDoctor/SeniorPhysicist",
                [WorkItemTypes.PrescriptionSync]           = "Physicist/System",
                [WorkItemTypes.PlanQA]                     = "Physicist/QAReviewer",
                [WorkItemTypes.PlanDoubleCheck]            = "SeniorPhysicist",
                [WorkItemTypes.ScheduleSync]               = "Scheduler/System",
                [WorkItemTypes.TreatmentOrder]             = "Doctor",
                [WorkItemTypes.QueueCall]                  = "System",
                [WorkItemTypes.TreatmentMonitor]           = "System",
                [WorkItemTypes.TreatmentExceptionHandling] = "Admin",
                [WorkItemTypes.PostTreatmentReview]        = "Doctor",
