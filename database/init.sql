...
DROP TABLE IF EXISTS "WorkflowTransitionAttribute" CASCADE;
DROP TABLE IF EXISTS "WorkflowTransitionFromStatus" CASCADE;
DROP TABLE IF EXISTS "WorkflowTransitionChangeLog" CASCADE;
DROP TABLE IF EXISTS "WorkflowTransition" CASCADE;
DROP TABLE IF EXISTS "WorkflowVocabularyChangeLog" CASCADE;
DROP TABLE IF EXISTS "WorkflowVocabularyTerm" CASCADE;
DROP TABLE IF EXISTS "WorkflowCaseStatusOverlay" CASCADE;
...
CREATE UNIQUE INDEX "IX_WorkflowTransition_Code"
    ON "WorkflowTransition" ("Code");

CREATE INDEX "IX_WorkflowTransition_Phase_SortOrder"
    ON "WorkflowTransition" ("Phase", "SortOrder");

CREATE TABLE "WorkflowTransitionAttribute"
(
    "TransitionId" uuid NOT NULL,
    "Kind" varchar(32) NOT NULL,
    "Value" varchar(128) NOT NULL,
    "SortOrder" integer NOT NULL,
    PRIMARY KEY ("TransitionId", "Kind", "Value"),
    CONSTRAINT "FK_WorkflowTransitionAttribute_WorkflowTransition_TransitionId"
        FOREIGN KEY ("TransitionId") REFERENCES "WorkflowTransition"("Id") ON DELETE CASCADE
);

CREATE TABLE "WorkflowTransitionFromStatus"
(
    "TransitionId" uuid NOT NULL,
    "FromStatus" varchar(64) NOT NULL,
    PRIMARY KEY ("TransitionId", "FromStatus"),
    CONSTRAINT "FK_WorkflowTransitionFromStatus_WorkflowTransition_TransitionId"
        FOREIGN KEY ("TransitionId") REFERENCES "WorkflowTransition"("Id") ON DELETE CASCADE
);

CREATE TABLE "WorkflowTransitionChangeLog"
(
    "ChangeLogId" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    "TransitionId" uuid NOT NULL,
    "Code" varchar(32) NOT NULL,
...
CREATE INDEX "IX_WorkflowTransitionChangeLog_Code_CreatedAt"
    ON "WorkflowTransitionChangeLog" ("Code", "CreatedAt");

CREATE INDEX "IX_WorkflowTransitionChangeLog_TransitionId_CreatedAt"
    ON "WorkflowTransitionChangeLog" ("TransitionId", "CreatedAt");

CREATE TABLE "WorkflowVocabularyTerm"
(
    "Id" uuid PRIMARY KEY,
    "Kind" varchar(32) NOT NULL,
...
CREATE UNIQUE INDEX "IX_WorkflowVocabularyTerm_Kind_Code"
    ON "WorkflowVocabularyTerm" ("Kind", "Code");

CREATE INDEX "IX_WorkflowVocabularyTerm_Kind_SortOrder"
    ON "WorkflowVocabularyTerm" ("Kind", "SortOrder");

CREATE TABLE "WorkflowVocabularyChangeLog"
(
    "ChangeLogId" bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE INDEX "IX_WorkflowVocabularyChangeLog_Kind_Code_CreatedAt"
    ON "WorkflowVocabularyChangeLog" ("Kind", "Code", "CreatedAt");

CREATE INDEX "IX_WorkflowVocabularyChangeLog_TermId_CreatedAt"
    ON "WorkflowVocabularyChangeLog" ("TermId", "CreatedAt");

CREATE TABLE "WorkflowCaseStatusOverlay"
(
...
CREATE INDEX "IX_WorkflowCaseStatusOverlay_Category"
    ON "WorkflowCaseStatusOverlay" ("Category");

CREATE INDEX "IX_WorkflowCaseStatusOverlay_SortOrder"
    ON "WorkflowCaseStatusOverlay" ("SortOrder");
